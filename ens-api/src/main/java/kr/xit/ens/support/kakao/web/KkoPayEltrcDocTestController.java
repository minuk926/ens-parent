...
public class KkoPayEltrcDocTestController {
    ...
    public ResponseEntity<? extends IRestApiResponse> modifyStatus(
        ...
        return RestApiResponse.of(StringUtils.EMPTY, HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<? extends IRestApiResponse> findStatus(
        ...
        return RestApiResponse.of(KkoPayEltrDocDTO.DocStatusRes
            .builder()
            .doc_box_status("READ")
            .doc_box_sent_at(1624344762)
            .doc_box_received_at(1624344762)
